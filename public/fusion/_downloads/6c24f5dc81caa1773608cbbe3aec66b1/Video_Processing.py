...
# %%
# **Demonstrating the video processing capabilities of SMART FUSION**
#
# This notebook will guide you progressively through the steps necessary to:
#
# 1. Use the SMART FUSION :class:`~.FrameReader` components to open and process video data;
...
# programs for handling video, audio, and other multimedia files and streams. SMART FUSION (or more
...
# SMART FUSION
# ~~~~~~~~~~
# To perform video-processing using SMART FUSION, we need to install some extra dependencies. The
# easiest way to achieve this is by running the following commands in a Terminal window:
#
# .. code::
#
#     git clone "https://github.com/claycurry34/Smart-Fusion.git"
#     cd Smart-Fusion
...
# %%
# Using the SMART FUSION :class:`~.FrameReader` classes
# ---------------------------------------------------
# The :class:`~.FrameReader` abstract class is intended as the base class for SMART FUSION readers
# that read frames from any form of imagery data. As of now, SMART FUSION has two implementations of
...
# `00:12`.
import datetime
from smartfusion.reader.video import VideoClipReader
...
from smartfusion.detector.tensorflow import TensorFlowBoxObjectDetector
...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# In this section we showcase how we can utilise SMART FUSION :class:`~.Feeder` objects in order to
...
from smartfusion.feeder.filter import MetadataValueFilter
...
# components to perform tracking of multiple objects within SMART FUSION.
#
...
# we proceed to construct our SMART FUSION :class:`~.TransitionModel` as follows:
...
# .. note::
#
#   For more information on the above classes and how they operate you can refer to the Smart
#   Fusion tutorial on
#   `using the Kalman Filter <https://smartfusion.readthedocs.io/en/latest/auto_tutorials/01_KalmanFilterTutorial.html>`_.
#
# Data Association
# ****************
...
#   `Data Association - clutter <https://smartfusion.readthedocs.io/en/latest/auto_tutorials/05_DataAssociation-Clutter.html>`_
#   and `Data Association - Multi-Target Tracking <https://smartfusion.readthedocs.io/en/latest/auto_tutorials/06_DataAssociation-MultiTargetTutorial.html>`_
#   tutorials.
...
from smartfusion.types.array import CovarianceMatrix, StateVector
...
#
#   For more information on the above classes and how they operate you can refer to the Smart
#   `Initiators & Deleters <https://smartfusion.readthedocs.io/en/latest/auto_tutorials/09_Initiators_&_Deleters.html>`_
#   tutorial.
#
