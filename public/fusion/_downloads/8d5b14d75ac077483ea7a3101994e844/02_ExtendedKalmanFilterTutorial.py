...
# %%
# As well as introducing various aspects of the SMART FUSION framework, the previous tutorial
...
#
# SMART FUSION implements the EKF
...
# ^^^^^^^^^^^^^^^^^^^^^^
#
# We're going to simulate a 2d bearing-range sensor. An example of this is available in SMART FUSION
...
# 2. Because SMART FUSION uses inheritance, the amount of engineering required to achieve this is
