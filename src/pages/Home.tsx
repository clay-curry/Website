    ...
    <>
      ...
      <PageContent>
        ...
        <p>
          ...
          to find me either surfing through open-source projects, jogging with Mia, my good German Sheppard, or self-studying (currently, it's <a href={conway}>John Conway's</a> <i>A Course in Point-Set Topology</i>).
        </p>

        <p>
          My interests are in machine learning broadly, but I 
          have taken interest in special topics described here on my website. Above all, my interests are in sharing and absorbing knowledge/research, creating research infrastructure, 
          maximizing research productivitiy, protecting national security, and improving environmental quality. 
        </p>
        <p>
...
function Hero() {
  ...
  return (
    <div className='hero'>
        ...
        <div className='text'>
        <div className='text'>Information Fusion ∩ Machine Learning</div>
        <div className='text'>Object Tracking ∩ Software Engineering</div>
