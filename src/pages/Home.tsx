  ...
  return (
    ...
    <NavBar />
      <div className='me'>
        ...
        <p>Deep Learning | Object Tracking</p>
          <div>
...
function Paragraph() {
  ...
  return (<Fragment>
    ...
    <div>
    <p>
    I'm a US-based deep learner, software engineer, and German Sheppard master interested in building and evangelizing technologies and systems that enhance safety, 
    security, environmental quality, and economic prosperity through interdisciplinary research. I am currently working as an undergraduate research assistant under the supervision 
    of <a href="https://www.ou.edu/coe/cs/people/hougen">Dean Hougen</a>, director of the School of Computer Science at the at the University of Oklahoma.
    Lately I have been working with engineers from the <a href={partnership}>Oklahoma City Air Logistics Complex's 76th Software Engineering Group</a> on projects
    geared towards information fusion in object-tracking sensor networks.</p>
    ...
    <p>I'm currently seeking full-time opportunities starting in December (my expected graduation date), which are likely to be stepping stones into 
      graduate school (though I am perfectly fine with taking a gap semester, or several). My interests are at the intersection of machine learning and object tracking. Please reach out with any 
      requests!</p>
    </div>
