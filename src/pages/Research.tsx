...
function Statement() {
  ...
  return (<Fragment>
    <h2>Research Statement</h2>
      ...
      <p>
        My goal is to contribute intuition, applications, and mathematical theorems that instill 
        rigor and tools for understanding and deriving gradient-based learning algorithms (i.e., 
        neural networks) under a small unified set of principles. I am particularly interested in 
        the role of <a href="https://www.pnas.org/doi/10.1073/pnas.93.25.14256">symmetry</a> in 
        deriving physically-motivated, data-efficient machine learning algorithms from first 
        principles. For instance, my recent work was motivated to push the limit of understanding 
        and applications of symmetry-aware machine learning algorithms by developing a novel 
        application for the defense and aerospace industry (i.e., autonomous flight maneuver 
        identification). Toward this goal, I have recently taken an interest in Geometric Deep 
        Learning, which considers each neural network architecture from the view of its symmetries. 
        Like in physics, symmetry is a fundamental principle from which future, previously unseen
        neural architectures may be constructed, presenting a solid avenue for its role in a general 
        unified theory of neural networks. For instance, the class of functions generated by 
        convolutional neural networks can be thought of as universally-approximating maps with 
        translational symmetry, RNNs can be thought of as universally-approximating transformations 
        with time-shift symmetry, transformers can be thought of as universally-approximating 
        functions with permutation symmetry, and graph neural networks can be thought of as 
        universally approximating correspondences with E(3) (Euclidean group) symmetry. 
      </p>
      <hr />
